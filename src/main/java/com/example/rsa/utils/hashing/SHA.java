...
@AllArgsConstructor
public class SHA implements Hashing{
    private String text;
    ...
    public BigInteger getInteger() {
        ...
        hex = Integer.toHexString(h0) + Integer.toHexString(h1) + Integer.toHexString(h2) + Integer.toHexString(h3) + Integer.toHexString(h4) + Integer.toHexString(h5) + Integer.toHexString(h6) + Integer.toHexString(h7);
